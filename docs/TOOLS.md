...
- [GitHub Copilot](#github-copilot)
  - [Global Instructions](#1-global-instructions-auto-applied)
  - [Path-Specific Instructions](#2-path-specific-instructions-auto-applied-by-pattern)
  - [Prompt Files](#3-prompt-files-manual-invoke)
  - [Task-Based Usage](#task-based-usage-invoke-agent-personas)
...
1. **Global instructions lists:**
   ...
   *Example: `@workspace #prompt:agent-code-reviewer` - Review this code*
   ```
