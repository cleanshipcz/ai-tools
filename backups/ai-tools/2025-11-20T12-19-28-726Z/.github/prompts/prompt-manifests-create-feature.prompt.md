...
Capture and clarify feature requirements, then create a simple feature.yml manifest

## Variables

- `{{user_description}}` (required): Brief user description of what the feature should do
- `{{project_id}}`: Project ID where the feature belongs (e.g., ai-tools)
